...
import { ShoppingCart, Phone, MapPin, Clock, Instagram, Plus, Minus, Trash2, CreditCard, FileText, Calendar, TrendingUp, Package, Lock, LogOut, Edit, Settings, Printer } from 'lucide-react'
...
export default function Home() {
  ...
  // Função para imprimir pedido - CORRIGIDA E FUNCIONAL
  const printOrder = (pedido: PedidoSupabase) => {
    ...
    const printContent = `
      ...
      <head>
        ...
        <style>
          ...
          @media screen {
            ...
            .cupom { background: white; max-width: 300px; margin: 0 auto; padding: 20px; box-shadow: 0 0 10px rgba(0,0,0,0.1); border-radius: 10px; }
            .header { text-align: center; border-bottom: 2px solid #000; padding-bottom: 10px; margin-bottom: 15px; }
            .item { margin-bottom: 10px; padding-bottom: 5px; border-bottom: 1px dashed #ccc; }
            .total { font-weight: bold; font-size: 14px; text-align: center; margin-top: 15px; padding-top: 10px; border-top: 2px solid #000; }
            .footer { text-align: center; margin-top: 15px; font-size: 10px; }
            .print-btn { background: #4CAF50; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; margin: 20px auto; display: block; }
      ...
      <body>
        ...
        <script>
          // Auto-print para dispositivos móveis
    ...
    try {
      ...
      if (printWindow) {
        ...
        // Para desktop, imprimir automaticamente após carregar
        if (!/Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
          setTimeout(() => {
            printWindow.print()
          }, 500)
  ...
  // Função para salvar promoção editada - CORRIGIDA
  ...
  // Função para salvar ingrediente editado - CORRIGIDA
            ...
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                ...
                <button
                  ...
                  className="bg-orange-500 text-white px-6 py-3 rounded-full font-bold hover:bg-orange-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                ...
                <button
                  ...
                  className="bg-yellow-500 text-white px-6 py-3 rounded-full font-bold hover:bg-yellow-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                          ...
                          <div className="flex items-center space-x-2 ml-4">
                            <button
                              onClick={(e) => {
                                e.preventDefault()
                                e.stopPropagation()
                                console.log('🖨️ Botão de impressão clicado para pedido:', pedido.id)
                                printOrder(pedido)
                              }}
                              className="bg-blue-500 text-white p-2 rounded-full hover:bg-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
